...
//    Description: A 5-card poker game for Arduboy, ported from Gamebuino.
//        Version: 1.0.0
//           Date: 19 May 2018
  ...
  while(1)
  {
    if(gb.update())
    {
        ...
        */
        ...
        // D Pad - Resume Game
        if(gb.buttons.pressed(BTN_UP) || gb.buttons.pressed(BTN_DOWN) || gb.buttons.pressed(BTN_LEFT) || gb.buttons.pressed(BTN_RIGHT))
        {
